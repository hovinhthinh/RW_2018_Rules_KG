...
\newcommand{\weak}{\ensuremath{\mathit{weak}}\xspace}
...
\newcommand{\flpred}[2]{\ensuremath{\mathit{f}#1^{#2}}\xspace}
\newcommand{\flpreddllp}[3]{\ensuremath{{#1^{#2,#3}_{\mathit{FLP}}}}\xspace}
\newcommand{\glred}[2]{\ensuremath{{#1^{#2}_{\mathit{GL}}}}\xspace}
\newcommand{\dlpred}[2]{\ensuremath{{#1^{#2}_{\mathit{d}}}}\xspace}
\newcommand{\strred}[2]{\ensuremath{{#1^{#2}_{\mathit{s}}}}\xspace}
\newcommand{\wred}[2]{\ensuremath{\mathit{w}#1^{#2}}\xspace}
\newcommand{\rhored}[2]{\ensuremath{\mathit{\rho_x}#1^{#2}}\xspace}
...
\newcommand{\gr}[1]{\ensuremath{grd(#1)}\xspace}
...
\newcommand{\lp}{\ensuremath{P}\xspace}

\newcommand{\fot}{\ensuremath{\cO}\xspace}
\newcommand{\DL}{\fot}
%\newcommand{\fot}{\ensuremath{\Phi}\xspace}
...
\newcommand{\cR}{\ensuremath{\mathcal{A}}}
...
\newcommand{\dlextension}[2]{\ensuremath{\lambda^{#1}(#2)}}
...
%\newcounter{exctr}
%\newcommand{\putctr}{\addtocounter{exctr}{1}(\arabic{exctr})}
