...
\begin{frame}\frametitle{Challenges of KG Rule Induction}
\begin{itemize}
\item[] \textbf{\bl{Open World Assumption}}: Negative examples are unavailable
\medskip

\gre{\emph{E.g., Maybe Albert Einstein was a ballet dancer?}}
\end{itemize}
\bigskip
\begin{center}
...
\begin{frame}\frametitle{Challenges of KG Rule Induction} 
\begin{itemize}
\item[] \textbf{\bl{Noise and bias}}\\
\medskip

\gre{\emph{E.g., as wikipedia stores mostly famous scientists, one can induce a wrong assumption that all scientists are Nobel prize winners}}
\end{itemize}
...
\begin{frame}\frametitle{Frequent Pattern Mining}
\end{frame}
...
\begin{frame}\frametitle{How to Apply to Relational Data?}
\end{frame}
