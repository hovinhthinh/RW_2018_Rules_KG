...
\begin{beamerboxesrounded}[upper=uppercolblue,lower=lowercolblue,shadow=true]{\textbf{\bl{In tutorial: }} }
\bigskip
...
\begin{frame}\frametitle{\alt<2>{Declarative Programming Example}{ASP: Declarative Programming Paradigm}}
\alt<2>{
 \begin{picture}(0.5,0.5)
...
\begin{frame}\frametitle{Rule Mining}
\alt<2>{\begin{picture}(0.5,0.5)
...
\begin{frame}\frametitle{Rule Mining from KGs}
