...
\end{itemize}
\end{enumerate}
\subsection{Completeness-awareness in Rule Learning}
...
also for increasing the scope of KGs and estimating their recall, recent works, e.g., \cite{} focused 
...
\vspace{-.2cm}
\leanparagraph{Completeness Confidence}
...
\vspace{-.2cm}
\leanparagraph{Completeness Precision and Recall}
...
\vspace{-.2cm}
\leanparagraph{Directional Bias}
