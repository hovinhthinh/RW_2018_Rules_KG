...
\leanparagraph{Learning from answer sets} In~\cite{DBLP:journals/tocl/Sakama05} %proposed 
...
DROPS~\cite{CorapiRL10} maps the ILP problem into an abductive learning task. The authors followed it with ASPAL~\cite{ASPAL} which reduces the learning problem into the problem of answer set computation by providing the dedicated encoding. 
