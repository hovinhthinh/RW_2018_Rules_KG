...
Note that by exploiting the embedding feedback, it is easier to distinguish
...
$\cG_r$ goes down. Ideally, %such
 ...
 the body of the rule such that the average quality of
$\cG_r$ increases, %as this will witness that by adding negated atoms to the rule we get rid of unlikely predictions. 
