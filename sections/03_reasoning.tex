...
\label{sec:reasoning}
In this section we briefly introduce logic programs (see \cite{DBLP:conf/rweb/EiterIK09} for more details) and relational association rules \cite{warmer}.
...
the rule are related to other properties in the head of the rule. For an example of an association rule, consider a
