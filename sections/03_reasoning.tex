...
Then the following association rule might be discovered: 30\% of the customers
buying a color printer also buy a scanner.
...
proposed (see Section~\ref{} for an overview). 

Following \cite{warmer} we now formally define relational association rules. An \emph{association rule} is of the form $Q_1 => Q_2$, such that $Q_1$ and $Q_2$ are both conjunctive queries and the body of $Q_1$ considered as a set of atoms is included in the body of $Q_2$,  i.e., $Q_1(\cG')\subseteq Q_2(\cG')$ for any possible KG $\cG'$. 
