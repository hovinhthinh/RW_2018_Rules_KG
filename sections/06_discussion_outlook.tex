...
%\leanparagraph{Hybrid rule learning techniques}
 \leanparagraph{Extracting rules from text and KG} Inducing rules from text by exploiting natural language processing (NLP) techniques has been studied in several works such as~\cite{Schoenmr logical inference.kers:2010,Gordon:2011,dragoni2016}. These methods proposed early methods for converting text into logical for logical inference. Combining these %linguistics-based 
