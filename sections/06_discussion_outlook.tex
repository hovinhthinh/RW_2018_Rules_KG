...
\leanparagraph{Learning rules over probabilistic data} Addressing the rule learning over weighted data has been studied under probabilistic ILP, where given a set of probabilistic examples for grounded atoms
