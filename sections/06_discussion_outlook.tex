...
of existing rule learning approaches over knowledge graphs %to 
model %those 
KGs as sets of true facts thus totally ignoring possible inaccuracies. %of some of the facts that they encode. 
Since KGs are usually %normally automatically 
