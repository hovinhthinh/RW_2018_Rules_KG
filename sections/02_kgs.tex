...
In addition to incompleteness and bias, KGs include some inaccurate facts. Such erroneous facts may easily appear as a result of the automatic extraction process. Furthermore, some facts are controversial, hence different values appear in the sources and even contributors and KG reviewers cannot agree on them. As an example, areas under conflict can be inaccurate in KGs.
...
the better these KGs. Along with completeness and absence of data bias, there are also other important aspects reflecting KGs' quality %. These 
