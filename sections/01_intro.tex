...
to capture KG patterns accurately, since they  cannot handle exceptions, which often appear in practical applications. Thus making predictions using Horn rules might result in incorrect facts.
