...
Along with the type of the input data used (e.g., examples, interpretations), there are several other parameters that distinguish the rule mining approaches \cite{DBLP:conf/semweb/SazonauS17}: 
\begin{itemize}
...
In Table~\ref{tab:ilp} we provide an overview of the most relevant for us existing inductive rule mining systems. 
