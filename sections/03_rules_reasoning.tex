...
\item Background knowledge $T$, i.e. an extensive set of facts over various relations that can be used to induce the definition of $p$; 
...
\item[] \textbf{Find:}
\begin{itemize}
\item A hypothesis $\mi{Hyp}$, such that $E$ is a minimal Herbrand model of $\mi{Hyp \cup T}$.
\end{itemize}
\end{itemize}
\end{definition}
