...
We now formally define the satisfaction relation. \gad{what is satisfaction relation?}
...
An overview of some of the systems for Horn and nonmonotonic rule induction with their properties are presented in Table~\ref{tab:ilp}. 
