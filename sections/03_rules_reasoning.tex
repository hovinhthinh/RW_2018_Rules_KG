...
Table \ref{tab:ilp} provides classifications of some traditional ILP systems that have been introduced in the literature to solve the above supervised learning task. In particular, we could assign them based on some following characteristics \cite{Boytcheva2007OverviewOI,R8146692}:
\begin{itemize}
