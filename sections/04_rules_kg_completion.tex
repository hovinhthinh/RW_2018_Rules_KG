...
Apart from standard confidence $conf$ and PCA confidence $conf_{pca}$, which works under Closed World Assumption and Partial Completeness Assumption, correspondingly, there also exist other measures introduced to quantify the quality of rules.
