...
\begin{itemize}
\item \textbf{Completeness Confidence}
First, the two indicators are defined for a given rule $r: %\vec{H}
...
\end{align*}
Exploiting these indicators, the \emph{completeness confidence} is defined as follows:
\begin{align*}\label{eq:comp_conf}
