...
The setting that has been most extensively studied in the context of inductive logic programming concerns the extractio of a hypothesis in a certain language from a set of positive and negative examples and a logical background theory. 
