...
In this work we focus on methods based on relational association rule learning and theory revision techniques for extraction of \emph{Horn} and \emph{nonmonotonic rules} from incomplete KGs treated under OWA and discuss exploitation of additional background knowledge that restricts that   
...
\subsubsection{RC Confidence.}
\thi{TODO}
\subsubsection{Laplace.}
(slightly similar to conf)
\thi{TODO}
