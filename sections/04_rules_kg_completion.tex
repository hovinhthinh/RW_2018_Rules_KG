...
\subsubsection{RC Confidence.} Another further proposal for KG-based rule measure has been done in \cite{DBLP:conf/www/ZupancD18}, which attempts to make use of information about the positive and unlabeled data. This rule measure directly estimate the precision of a rule as follows:
\[
