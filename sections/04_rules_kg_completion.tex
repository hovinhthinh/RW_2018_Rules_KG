...
Learning rules from knowledge graph consists of two phases: constructing the rules and examining their quality based on the KG. Most of state-of-the-art rule mining systems parallelize only construction of the rules, while the quality of the rules are determined with a single thread.
