...
This rule has confidence $conf = \frac{6}{10}$, saying that people only live in metropolitan, which is incorrect. \thi{I also added this rule, since the rule below is existential rule, which might be not enough}.
Another example is:
